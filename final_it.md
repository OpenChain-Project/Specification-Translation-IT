...
Persona di Contatto FOSS <!-- Nota, anche questo è stato modificato rispetto
all'ultima versione --> :    Una persona designata a ricevere [`domande |
richieste di informazioni` `<!-- FIXME scegliere -->` ] circa il FOSS.
...
marketing e product management` `<!-- FIXME come tradurre questa roba? Ha senso?
--> `]
...
<!-- Marco, devi usare gli stili di intestazione H1 - H3 per i titoli,
     altrimenti mi sconvolgi tutto il lavoro ;-) -->
