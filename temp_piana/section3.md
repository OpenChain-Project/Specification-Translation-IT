...
**3.1        Esiste un processo per creare e gestire una lista di materiali per il componente FOSS che include ciascun componente (e le sue Licenze Identificate) in una versione del Software Fornito.**
...
> **Razionale**:
>
> Per garantire che esiste un processo per creare e gestire una lista dei materiali 
...
**3.2 Il programma di gestione del FOSS deve essere in grado di gestire i 
casi comuni d'uso di licenza FOSS incontrati dallo Staff del Software per 
il Software Fornito, che possono includere i seguenti casi d'uso (si noti 
che l'elenco non è esaustivo e non si applicano tutti i casi d'uso):**
...
> **Razionale**:
>
> Per assicurare che il programma è sufficientemente robusto per gestire
